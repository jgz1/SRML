...
<header id="Cabeza">
        <div id="DescripcionPagina"> 
			...
			<div id="DescripcionTitulo">Equipos</div> <!--Titulo de la pagina-->
		</div>
        ...
        <div id="itemEquipo">
            <nav><a href="Registro_Equipo_Computo.php"><img id = "mantenimiento" src="images/Registro.png" alt=""></a></nav>
            <h1 id = "titulo">Registro</h1>
        </div>
        
        <div id="itemEquipo">
        <nav><a href="consultaEquipo.php"><img id = "mantenimiento" src="images/consulta.png" alt=""></a></nav> 
